        ...
        <div className="max-w-7xl mx-auto px-6 font-serif">
          <div className="space-y-16">
            {destinations.map((destination, index) => (
              <Card 
                key={destination.id}
                className="border-0 shadow-none bg-transparent animate-fade-up"
            ...
            <div className="flex justify-center items-center mb-5 animate-fade-in-out">
              <Button
                variant="outline"
                onClick={() => navigate('/')}
                className="group w-fit text-black bg-white hover:bg-gray-200 hover:bg-accent"
              >
            ...
            <div className="flex justify-center items-center mb-4 animate-fade-in-out">
              <Button 
                variant="outline" 
                size="lg" 
                className="group w-fit text-black bg-transparent border-white hover:bg-gray-200 hover:bg-accent"
