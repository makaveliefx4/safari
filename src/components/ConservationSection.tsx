...
import { ArrowRight, Heart, Shield, Users, TreePine, CheckCircle, EyeIcon } from 'lucide-react';
...
const initiatives = [
	{
		...
		description:
			'Funding ranger patrols and advanced technology to protect endangered species from illegal hunting.',
	...
	},
	{
		...
		description:
			'Restoring degraded ecosystems and creating wildlife corridors for animal migration.',
	...
	},
	{
		...
		description:
			'Creating sustainable livelihoods for local communities through eco-tourism and education.',
	...
	},
	{
		...
		description:
			'Rescuing and rehabilitating injured wildlife with our partner veterinary clinics.',
	...
	return (
        ...
        <div className="text-center mb-16 animate-fade-up">
          ...
          <Button
            variant="outline"
            size="lg"
            className="w-full md:w-auto px-8 py-6 rounded-full shadow-lg border-2 border-border"
          >
