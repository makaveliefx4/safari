      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 p-4">
          <Button
            variant="outline"
            size="lg"
            className="w-full md:w-auto group px-8 py-4 rounded-md shadow-lg border-border"
          ...
          <a
            ...
            className="w-full md:w-auto inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground px-8 py-4 group rounded-md shadow-lg border-border"
          >
