...
import jeoImage from '@/assets/jeo.jpg'; 

const stats = [
  { icon: Star, number: '4.9/5', label: 'Average Rating', description: 'From 500+ verified reviews', color: 'text-accent' },
  { icon: Globe, number: '15+', label: 'Years Experience', description: 'In luxury African safaris', color: 'text-primary' },
  { icon: Award, number: '98%', label: 'Customer Satisfaction', description: 'Return & recommendation rate', color: 'text-accent' },
  { icon: Heart, number: '$2.5M+', label: 'Conservation Impact', description: 'Contributed to wildlife protection', color: 'text-primary' },
];
...
export function StatsSection() {
  return (
    <section className="relative py-24 rounded-[40px] overflow-hidden">
      <div
        className="absolute inset-0 w-full h-full bg-cover bg-center"
        style={{ backgroundImage: `url(${jeoImage})` }}></div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 animate-fade-in-out">
        <div className="flex justify-center mb-6 -mt-15">
          <img src={TripaImage} alt="Awards" width={120} height={186} className="object-contain" />
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {stats.map((stat, index) => (
            ...
            >
              <div className={`bg-${stat.color.replace('text-', '')}/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6`}>
        ...
        <div className="text-center">
          ...
          <span className="text-xl tracking-widest text-muted-foreground -mt-10 block">. . . . . . .</span>
